...
class HarParser(object):
    ...
    def _make_request_url(self, testcase_dict, entry_json):
        ...
        if request_params:
            ...
            testcase_dict["params"] = request_params
        else:
    ...
    def _make_request_headers(self, testcase_dict, entry_json):
        ...
        if testcase_headers:
            ...
            testcase_dict["headers"] = testcase_headers
    ...
    def _make_request_data(self, testcase_dict, entry_json):
        ...
        if method in ["POST", "PUT"]:
            ...
            testcase_dict[request_data_key] = post_data
    ...
    def make_testcases(self):
        ...
        for entry_json in self.log_entries:
            ...
            testcases["{}".format(self.change_api_name(self.make_testcase(entry_json)['name']))] = self.make_testcase(entry_json)
